...
package com.strimm.application.lib.item
...
//        }
    ...
    fun setValues(
        ...
        timingView.setTextColor(Color.parseColor(mainThemeData.primaryColor))
        titleView.setTextColor(Color.parseColor(mainThemeData.textSecondaryColor))


        if (schedule?.program != null) {
            var videoItem = schedule?.program as VideoItem

            val titleTiming =
                if (title?.isEmpty() == true) resources.getString(R.string.title_no_program) else videoItem.durationInDate
            timingView.setText(titleTiming)
        } else {
            timingView.setText("No Video")
        }
        ...
        title =
            if (title?.isEmpty() == true) resources.getString(R.string.title_no_program) else title
